...
from Fenix.functions.misc import rotate_image
...
async def mi(e):
    ...
    url = await make_html_telegraph("Mediainfo", "𝒉𝒆𝒂𝒓𝒕𝒍𝒆𝒔𝒔", f"<code>{murl}</code>")
    ...
    try:
        urll = await make_html_telegraph("Mediainfo", "𝒉𝒆𝒂𝒓𝒕𝒍𝒆𝒔𝒔", out)
