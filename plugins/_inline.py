...
from Fenix._misc._assistant import callback, in_pattern
from Fenix.dB._core import HELP, LIST
from Fenix.functions.helper import gen_chlog, time_formatter, updater
from Fenix.functions.misc import split_list
...
async def inline_alive(o):
    MSG = "ᥴᥣiᥴκ ᴛɦᥱ δᥙᴛᴛ᧐ᥒ δᥱᥣ᧐ᥕ ᴛ᧐ ᥴ᧐ᥒᴛᥲᥴᴛ !"
    ...
    await o.answer(
        ...
        private=True,
        cache_time=300,
        switch_pm="𝒂𝒔𝒔𝒊𝒔𝒕𝒂𝒏𝒕 𝒐𝒇 𝒉𝒆𝒂𝒓𝒕𝒍𝒆𝒔𝒔 [🇫🇷]",
