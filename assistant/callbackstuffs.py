...
try:
    from Fenix.functions.gDrive import GDriveManager
except ImportError:
    GDriveManager = None
from Fenix.functions.helper import fast_download, progress
...
from Fenix.startup.loader import Loader
...
_buttons = {
    "otvars": {
        "text": "Other Variables to set for @PentesterX_Bot:",
        "buttons": [
            [
...
async def update(eve):
    ...
    if heroku_api:
        ...
        execl(sys.executable, sys.executable, "-m", "Fenix")
